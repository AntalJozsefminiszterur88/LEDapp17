...
class GUI2_ControlsWidget(QWidget):
    def __init__(self, main_app, parent=None):
        ...
        color_grid_layout.setRowStretch(total_rows + 1, 0)
    ...
    def delete_custom_color(self, name):
        if remove_custom_color(name):
            try:
                ...
                QMessageBox.warning(self, "Hiba", "Nem sikerült a GUI frissítése.")
        else:
            QMessageBox.warning(self, "Hiba", "Nem sikerült törölni a színt.")
    ...
    def pick_custom_color(self):
        ...
        if ok and name:
            ...
            if entry:
                ...
                QMessageBox.warning(self, "Hiba", "A szín hozzáadása nem sikerült.")
